                ...
                // $("#waterfull").css("height", maxTop+20);
                    if(maxTop<($(window).height()+$(document).scrollTop())){
                        ...
                        if(itemNum>=data.length+6){
                            ...
                            var html="";
                            for(var i in data1){
                                html+='<li class="item clear"><a href="javascript:" class="a-img"><img    src=../upload/'+data1[i].avatar +' alt=""></a><div class="clear s-detail"><div class="fl"><img    src=../upload/'+data1[i].img +' alt="头像"></div><div class="fl"><div class="fl-top"><span>'+data1[i].stuName +'</span><em>'+data1[i].classInfo +'</em></div><div class="fl-bot"><span>'+data1[i].type +'</span></div></div></div></li>';
                            }
                            data1 =[];
